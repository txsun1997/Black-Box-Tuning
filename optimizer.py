...
from onnxruntime.transformers.onnx_model_bert_tf import BertOnnxModelTF
from onnxruntime.transformers.onnx_model_bert_keras import BertOnnxModelKeras
...
def optimize_by_onnxruntime(onnx_model_path: str,
    ...
    if not use_gpu:
        ...
        session = onnxruntime.InferenceSession(onnx_model_path, sess_options, providers=['CPUExecutionProvider', 'CUDAExecutionProvider'], **kwargs)
